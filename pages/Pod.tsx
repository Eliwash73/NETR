import { View, Text, StyleSheet, FlatList, useColorScheme, ScrollView, Pressable, TextInput } from "react-native";
import { router, useIsFocused, useLocalSearchParams } from "expo-router";
import { SetStateAction, useState } from "react";
import Modal from "react-native-modal";
import { SelectList } from "react-native-dropdown-select-list";
import useScreenDimensions from "@/hooks/useScreenDimensions";
import { GREY, HONEYDEW, PEACH, PURPLE, RED, TEAL, YELLOW,
    colorChanger, colorSelect } from "@/components/NETRTheme";
        ...
        <View style={styles.addPodModal}>
          <ScrollView>
            ...
            <View style={styles.addPodModalColor}>
              <SelectList
                setSelected={(val: SetStateAction<string>) => setSelectedColor(val)}
                data={colorSelect}
                save="value"
                search={false}
